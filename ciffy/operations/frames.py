...
Functions for computing local coordinate frames, aligning residues,
and chaining residues using SE(3) transforms. These operations are
commonly used in ML models for structure prediction.
"""
