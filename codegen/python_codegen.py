...
def generate_python_atoms_v2(
    ...
    The actual AtomGroups with metadata are created in _generated_residues_v2.py.
    """
    ...
    lines = [
        ...
        'The actual AtomGroup instances with metadata are in _generated_residues_v2.py.',
        '"""',
        '',
        'import numpy as np',
        '',
    ...
    (biochem_dir / "_generated_atoms_v2.py").write_text('\n'.join(lines))
    print("Generated: biochemistry/_generated_atoms_v2.py")


def generate_python_residues_v2(
    biochem_dir: Path,
    all_residues: list[ResidueDefinition],
) -> None:
    ...
    # Import atom data
    if atom_class_names:
        lines.append('from ._generated_atoms_v2 import (')
        for name in atom_class_names:
    ...
    (biochem_dir / "_generated_residues_v2.py").write_text('\n'.join(lines))
    print("Generated: biochemistry/_generated_residues_v2.py")
